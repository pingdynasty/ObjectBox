...
public class BytesType extends ReflectionType{

    public BytesType(ReflectionTypeResolver resolver){
        super(resolver, BytesNode.TYPE);
    }
...
//      public Node primitive(String string){
