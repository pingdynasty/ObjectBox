...
public class ToListFunction extends XPathFunction{

    Type type;

    public ToListFunction(Name name, Type[] sig, Type type){
        super(name, sig);
        this.type = type;
    }
	...
	if(args[0] instanceof ReflectionNode){
	    ReflectionNode arg = (ReflectionNode)args[0];
	    Object[] array = (Object[])arg.getInstance();
	    List list = Arrays.asList(array);
	    return new ReflectionNode(type, list);
	}else{
