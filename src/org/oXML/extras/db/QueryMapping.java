...
public class QueryMapping implements TemplateMapping{

    public static final Name NAME = 
	new Name(DatabaseExtensions.DB_NS, "query");
...
// 	    TargetTemplate target = factory.buildTargetTemplate(result);
	...
	if(dir.hasQuery(nm))
            Log.warning("multiple definition of query: "+nm);
        else
            dir.setQuery(nm, query);

	return new QueryTemplate(nm, query);
    }
}
/*
