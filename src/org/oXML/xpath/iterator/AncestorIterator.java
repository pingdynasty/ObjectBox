 ...
 */
public class AncestorIterator extends SubNodeIterator
{
    private Node last;

    public AncestorIterator(NodeIterator root, NodeFilter filter){
        super(root, filter);
    }
...
//       * copy ctor
//       */
//      public AncestorIterator(AncestorIterator other)
//      {
//          super(other);
//          last = other.last;
//      }
