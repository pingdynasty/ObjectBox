...
import org.oXML.xpath.iterator.DescendantOrSelfNodeIterator;

public class DescendantOrSelfAxis extends Axis
{
    public DescendantOrSelfAxis(){
        super(DESCENDANT_OR_SELF);
    }

    public NodeIterator eval(NodeIterator parent, NodeTest test, RuntimeContext context)
        throws XPathException{
        DescendantOrSelfNodeIterator nit = 
            new DescendantOrSelfNodeIterator(parent, test.eval(context));
        if(test.principal())
