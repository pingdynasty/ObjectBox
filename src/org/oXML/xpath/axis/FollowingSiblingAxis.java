...
import org.oXML.xpath.iterator.FollowingSiblingIterator;

public class FollowingSiblingAxis extends Axis
{
    public FollowingSiblingAxis()
    {
        super(FOLLOWING_SIBLING);
    }

    public NodeIterator eval(NodeIterator parent, NodeTest test, RuntimeContext context)
        throws XPathException
    {
        FollowingSiblingIterator nit = new FollowingSiblingIterator(parent, test.eval(context));
        if(test.principal())
