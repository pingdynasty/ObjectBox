...
import org.oXML.engine.template.ThrowTemplate;
...
public class ThrowMapping implements TemplateMapping{
	...
	if(expr.equals(""))
		...
		(e, "missing required attribute: select");

	Expression exception = ctxt.parse(expr);
	Resolver resolver = ctxt.getResolver(e);
	exception.bind(resolver);
	return new ThrowTemplate(exception, resolver.getLocation());
    }
}
/*
